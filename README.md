...
###### **In Version 2 of this project, I added a Power BI dashboard to visualize gameplay analytics.**
...
* ###### **`data/GameEvents.csv` — Raw gameplay event data**
* ###### **`data/GameEventsData.xlsx` — Excel version of gameplay data**
* ###### **`sql/analytics.sql` — SQL queries used for analysis**
* ###### **`powerBI/Player\_Behavior\_Analytics\_Dashboard.pbix` — Power BI dashboard file**
* ###### **`powerBI/dashboard\_screenshot.png` — Power BI dashboard screenshot**
